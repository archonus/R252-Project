...
from quantum_transformers.quantum_layer import DressedQuantumLayer
...
class MultiHeadSelfAttention(nn.Module):
    ...
    quantum_num_qubits: int = 4  # Keep this small (e.g., 4 to 10) for simulation
    ...
    def __call__(self, x, deterministic):
        ...
        if self.quantum_circuit is None:
            ...
            q, k, v = [
                proj(x).reshape(batch_size, seq_len, self.num_heads, head_dim).swapaxes(1, 2)
                for proj, x in zip([
                    DressedQuantumLayer(num_qubits=self.quantum_num_qubits, out_features=hidden_size, w_shape=self.quantum_w_shape, circuit=self.quantum_circuit),
                    DressedQuantumLayer(num_qubits=self.quantum_num_qubits, out_features=hidden_size, w_shape=self.quantum_w_shape, circuit=self.quantum_circuit),
                    DressedQuantumLayer(num_qubits=self.quantum_num_qubits, out_features=hidden_size, w_shape=self.quantum_w_shape, circuit=self.quantum_circuit)
                ], [x, x, x])
            ]
        ...
        if self.quantum_circuit is None:
            x_out = nn.Dense(features=hidden_size)(values)
        else:
            x_out = DressedQuantumLayer(num_qubits=self.quantum_num_qubits, out_features=hidden_size, w_shape=self.quantum_w_shape, circuit=self.quantum_circuit)(values)
...
class FeedForward(nn.Module):
    ...
    def __call__(self, x, deterministic):
        ...
        if self.quantum_circuit is not None:
            x = DressedQuantumLayer(num_qubits=self.quantum_num_qubits, out_features=self.mlp_hidden_size, w_shape=self.quantum_w_shape, circuit=self.quantum_circuit)(x)
...
class TransformerBlock(nn.Module):
    ...
    def __call__(self, x, deterministic):
        ...
        attn_output = MultiHeadSelfAttention(
            ...
            quantum_num_qubits=self.quantum_num_qubits)(attn_output, deterministic=deterministic)
        ...
        y = FeedForward(hidden_size=self.hidden_size, mlp_hidden_size=self.mlp_hidden_size,
                        ...
                        quantum_num_qubits=self.quantum_num_qubits)(y, deterministic=deterministic)
    ...
    def __call__(self, x, train=False):
        ...
        for _ in range(self.num_transformer_blocks):
            x = TransformerBlock(
                ...
                quantum_num_qubits=self.quantum_num_qubits
